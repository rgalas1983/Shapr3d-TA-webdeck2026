  ...
  return (
    <div className="space-y-16 py-8 animate-fade-in">
      <header className="space-y-6 max-w-4xl">
        <div className="inline-block px-3 py-1 bg-blue-600/20 text-blue-500 text-[10px] font-bold uppercase tracking-[3px] rounded">
          Shapr3D Talent Acquisition Strategy 2026
        </div>
        <h1 className="text-6xl lg:text-8xl font-black text-white leading-tight tracking-tighter">
          Talent Operating <br/>
          <span className="text-zinc-700">Model 2026</span>
        </h1>
        <p className="text-2xl text-zinc-400 font-light max-w-2xl leading-relaxed">
          An <span className="text-white font-medium italic">Input → Framework → Output</span> system focused on Speed, Success, and Quality of Hire.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pt-12 border-t border-zinc-800">
        ...
        <div className="space-y-4">
          <h2 className="text-blue-500 font-bold uppercase tracking-widest text-xs tracking-[2px]">Principal 02</h2>
        ...
        <div className="space-y-4">
          <h2 className="text-blue-500 font-bold uppercase tracking-widest text-xs tracking-[2px]">Principal 03</h2>
          <p className="text-xl font-medium text-white">Outputs: Speed, Success, Quality</p>
          <p className="text-zinc-500 text-sm leading-relaxed">We measure performance by the delta in talent density across the organization.</p>
        </div>
      </div>

      <div className="bg-zinc-900/50 p-12 rounded-[2.5rem] border border-zinc-800 space-y-8">
        <div className="max-w-2xl">
          <h3 className="text-[10px] font-black uppercase tracking-[3px] text-zinc-500 mb-6">System Purpose</h3>
          <p className="text-2xl text-zinc-300 font-light leading-relaxed">
            This document defines how Talent Acquisition at Shapr3D operates as a system. It is not a hiring plan—it is an operating model that translates real-world constraints into predictable hiring outcomes.
          </p>
        </div>
        <button 
          onClick={onNext}
